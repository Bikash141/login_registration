    ...
    <div class="row">
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    <div class="col-md-12"><h5>Name : <?php echo $_SESSION['logname']?></h5></div>
                    <div class="col-md-12"><h5>Phone : <?php echo $_SESSION['logname']?></h5></div>
                ...
                <!--<div class="mt-5 text-center"><a href="retrive.php"><button name="submit" class="btn btn-primary profile-button" type="submit">Edit Profile</button></a></div>-->
                <a href="retrive.php" class="btn btn-primary profile-button" type="btn">Edit Profile</a>
            </div>
        </div>
    </div>
</div>
